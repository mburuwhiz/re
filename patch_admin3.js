...
// 4. Add update button by splitting and replacing precisely
const findStr = 'title="Generate QR Code"';
const index = content.indexOf(findStr);
if (index > -1) {
  const insertIndex = content.lastIndexOf('<button', index);
  ...
  content = content.substring(0, insertIndex) + btnCode + content.substring(insertIndex);
}
